...
{{ include "spring-demo.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
*/}}
{{- define "spring-demo.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "spring-demo.fullname" .) .Values.serviceAccount.name }}
{{- else }}
